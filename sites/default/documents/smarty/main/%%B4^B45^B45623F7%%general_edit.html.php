<?php /* Smarty version 2.6.33, created on 2022-09-16 12:37:28
         compiled from /var/www/html/absemr/templates/insurance_companies/general_edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'attr', '/var/www/html/absemr/templates/insurance_companies/general_edit.html', 14, false),array('function', 'xlt', '/var/www/html/absemr/templates/insurance_companies/general_edit.html', 17, false),array('function', 'html_options', '/var/www/html/absemr/templates/insurance_companies/general_edit.html', 112, false),)), $this); ?>
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-row my-sm-2">
        <label for="cqm_sop" class="col-form-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'CQM Source of Payment'), $this);?>
</label>
        <div class="col-sm-8">
            <select id="cqm_sop" name="cqm_sop" class="form-control">
                <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['insurancecompany']->cqm_sop_array,'selected' => $this->_tpl_vars['insurancecompany']->get_cqm_sop()), $this);?>
