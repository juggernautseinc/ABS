<?php /* Smarty version 2.6.33, created on 2022-09-10 19:37:32
         compiled from /var/www/html/absemr/templates/x12_partners/general_edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xlt', '/var/www/html/absemr/templates/x12_partners/general_edit.html', 13, false),array('function', 'html_options', '/var/www/html/absemr/templates/x12_partners/general_edit.html', 58, false),array('modifier', 'attr', '/var/www/html/absemr/templates/x12_partners/general_edit.html', 15, false),)), $this); ?>
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-row my-sm-2">
        ...
        <div class="col-sm-8">
            <input type="text" maxlength="45" id="x12_sftp_host" name="x12_sftp_host" class="form-control" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['partner']->get_x12_sftp_host())) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
" onKeyDown="PreventIt(event)">
        </div>
    </div>
    <div class="form-row my-sm-2">
